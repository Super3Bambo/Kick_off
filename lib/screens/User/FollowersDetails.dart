...
class Followers_Details extends StatefulWidget{
  final User userid;

  Followers_Details({this.userid});
    
 
  @override
  _Followers_DetailsState createState() => _Followers_DetailsState();
}

class _Followers_DetailsState extends State<Followers_Details> {
