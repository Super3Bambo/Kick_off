...
class Following_Details extends StatefulWidget{
  final User userid;

  Following_Details({this.userid});
    
 
  @override
  _Following_DetailsState createState() => _Following_DetailsState();
}

class _Following_DetailsState extends State<Following_Details> {
