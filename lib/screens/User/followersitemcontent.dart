...
class FollowersItemcontent extends StatelessWidget {
  final User followers;
  FollowersItemcontent({ this.followers });
  ...
  Widget build(BuildContext context) {
    ...
    int sumMorality = 0;
    int sumPos = 0;
      followers.rating.map((e) => e.Skills).forEach((int e){sumskills += e;});
      double skillscount= sumskills/followers.rating.length;   
       followers.rating.map((e) => e.Morality).forEach((int e){sumMorality += e;});
      double moralitycount= sumMorality/followers.rating.length;   
       followers.rating.map((e) => e.Position_Skills).forEach((int e){sumPos += e;});
      double poscount= sumPos/followers.rating.length;   
    ...
    child:  Container(
        ...
        child: new Column(
          ...
          children: <Widget>[
            new Text(followers.FName + ' '+followers.LName,
    ...
    child:  CircleAvatar(
                     ...
                     child: SizedBox(
                          width: 85.0,
                          height: 85.0,
                            child: Image.network(followers.Photo_url , fit: BoxFit.fill, ),
