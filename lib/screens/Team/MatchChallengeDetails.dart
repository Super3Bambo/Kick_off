...
class MatchChallenge_Details extends StatefulWidget{
  ...
  MatchChallenge_Details({this.matchid});
...
class _MatchChallenge_DetailsState extends State<MatchChallenge_Details> {
            ...
            CupertinoDialogAction(
              ...
              onPressed: () async {
                ...
                await Navigator.push(context,
                    MaterialPageRoute(builder: (context) => MatchesOverview()));
              },
            )
          ],
        ));
  ...
  Future onSelectNotification(String payload)async{
    ...
    await Navigator.push(context, new MaterialPageRoute(builder: (context) =>MatchesOverview()));
  }
