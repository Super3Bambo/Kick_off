...
import 'package:flutter_app/screens/Matches/MatchBoardDetails.dart';
import '../../models/Matches.dart';
//import './Field_Details.dart';
import './Match_Details_Complete.dart';

class MatchBoardItem extends StatelessWidget {


  final Match match;
  MatchBoardItem({ this.match });

  @override
  Widget build(BuildContext context) {

    godetails(Match id){
      Navigator.push(context,MaterialPageRoute(builder: (context)=> MatchBoardDetails(matchid: match)  ) );
